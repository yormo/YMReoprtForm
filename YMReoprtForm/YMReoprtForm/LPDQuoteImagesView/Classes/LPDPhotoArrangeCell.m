...
- (instancetype)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]){
        ...
        _videoThumbnail.image = [UIImage imageNamedFromMyBundle:@"MMVideoPreviewPlay"];
        ...
        _jiaImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 38, 38)];
        _jiaImgView.center = self.contentView.center;
        _jiaImgView.contentMode = UIViewContentModeScaleAspectFit;
        [self addSubview:_jiaImgView];
