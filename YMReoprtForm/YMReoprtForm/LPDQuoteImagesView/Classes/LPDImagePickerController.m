...
- (instancetype)initWithSelectedAssets:(NSMutableArray *)selectedAssets selectedPhotos:(NSMutableArray *)selectedPhotos index:(NSInteger)index{
    ...
    if (self) {
        ...
        previewVc.doneButtonClickBlockWithPreviewType = ^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    photoPickerVc.model = model;
    __weak typeof(self) weakSelf = self;
    photoPickerVc.backButtonClickHandle = ^(LPDAlbumModel *model) {
        (weakSelf.albumArr)[indexPath.row] = model;
    };
